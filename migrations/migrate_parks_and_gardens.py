        ...
        with cursor:
            ...
            for park in data:
                for address in park['addresses']:
                    district_id = int(address.get('district_id')) if address.get('district_id') and address.get('district_id').isdigit() else None
                    neighborhood_id = int(address.get('neighborhood_id')) if address.get('neighborhood_id') and address.get('neighborhood_id').isdigit() else None
